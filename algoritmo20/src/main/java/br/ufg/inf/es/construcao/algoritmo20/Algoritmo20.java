...
public class Algoritmo20 {
    ...
    /**
     * Calcula a rezao aurea entre dois termos.
     * @param termo1 Numero maior que zero.
     * @param termo2 Numero maior que o primeiro termo.
     * @param fator  Numero maior que zero.
    ...
    public static double razaoAurea(int termo1, int termo2, int fator) {
        if (termo1 <= 0) {
            throw new IllegalArgumentException("O primeiro termo deve ser maior que zero.");
        }
        if (termo2 <= termo1) {
            throw new IllegalArgumentException("O segundo termo deve ser maior que o primeiro.");
        }
        if (fator <= 0) {
