...
/**
     ...
     * @param k Quantidade de termos da somatoria. Quanto maior, mais preciso
     *          e o resultado. Deve ser maior ou igual a dois.
    ...
    public static double logNatSimples(int n, int k) {
        ...
        if (k < 2) {
            throw new IllegalArgumentException("O 'k' deve ser maior ou igual a 2.");
        }
